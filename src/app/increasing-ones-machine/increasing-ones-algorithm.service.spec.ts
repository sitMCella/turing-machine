...
describe("IncreasingOnesAlgorithmService", () => {
  ...
  beforeEach(() => {
    ...
    increasingOnesAlgorithmService = new IncreasingOnesAlgorithmService(
  ...
  describe("evolve", () => {
    describe("default initial tape", () => {
      ...
      beforeEach(() => {
        defaultInitialTape =
          increasingOnesAlgorithmService.getDefaultInitialTape();
      });
      ...
      it("should create machine statuses with correct square values", () => {
        ...
        const expectedTapeIndexes: Array<number> = [
          0, 2, 2, 4, 6, 5, 3, 1, 2, 4, 6, 8, 6, 4, 4, 6, 8, 10, 9, 7, 8, 10,
          12, 12,
        ];
        const machineStatus: Array<MachineStatus> = [];
        ...
        for (let tapeIndex = 0; tapeIndex < 23; tapeIndex++) {
          ...
          expect(machineStatus[tapeIndex].index).toBe(
            expectedTapeIndexes[tapeIndex],
          );
        }
      });
      ...
      it("should set errorMessage on evolution error", () => {
        ...
        expect(increasingOnesAlgorithmService.errorMessage).toBe(
          "Max tape length reached",
        );
      });
    });
    ...
    describe('initial tape with "1" as fifth square symbol', () => {
      ...
      beforeEach(() => {
        ...
        initialTape = <Tape>(
          deepCopy.apply(increasingOnesAlgorithmService.getDefaultInitialTape())
        );
